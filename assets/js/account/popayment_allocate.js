$(function(){
	...
	var dataTable = $('#table-grid').DataTable({
		...
		"destroy":true,
		"ajax":{
			url :base_url+"Main_account/table_popayment_allocate_forcheck", // json datasource
	...
	$("#form1").submit(function(e){
        ...
        serializedForm.push({
         ...
         $.ajax({
                type:'post',
                url:base_url+'Main_account/tbl_popaymentallocate_save',
                data: serializedForm,
                beforeSend:function(data){
                ...
                if(data.success == 1)
                    {        
                      ...
                      //   window.setTimeout(function(){
                      //        window.location.href=base_url+"Main_account/popayment_allocate/" + token+'/'+checkno+'/'+idno;;
                      // }, 500)
                    }else{
