                                ...
                                <div class="row">
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="applicantIdNo" class="form-control em_rField" autocomplete="off" value = "<?=generate_player_no()?>">
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="contactNo" class="form-control em_rField contactNumber" autocomplete="off">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
