 ...
 <div class="content-inner" id="pageActive" data-num="10" data-namecollapse="" data-labelname="Reports">
     <div class="bc-icons-2 card mb-4">
         <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
             ...
             <li class="breadcrumb-item active">SSS Reports</li>
         </ol>
     </div>
             ...
             <div class="card">
               ...
               <div class="card-body">
                <div class="table-responsive">
                  <table id = "sss_reports_tbl" class="table table-bordered table-striped" >
                    <thead>
                      <th>SSS #</th>
                      <th>Employee Id</th>
                      <th>Employee Name</th>
 ...
 <script src = "<?=base_url('assets\js\reports\sss_reports.js')?>"></script>
