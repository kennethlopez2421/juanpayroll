...
<div class="content-inner" id="pageActive" data-num="10" data-namecollapse="" data-labelname="Reports">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Pagibig Reports</li>
        </ol>
    </div>
            ...
            <div class="card">
              <div class="card-header">
               <div class="form-group row">
                 ...
                 <div class="col-md-4 text-right">
                   <!-- <a href="<?=base_url('reports/Sss_reports/export_to_excel_sss_reports/'.$token)?>"><button class="btn btn-sm btn-primary">Export to Excel</button></a> -->
                   <button data-toggle="modal" id="searchButton" class="btn btn-primary btnClickAddArea">Search</button>
                   <button class="btn btn-sm btn-primary" id = "btnExport">Export to Excel</button>
                 </div>
               </div>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id = "pagibig_reports_tbl" class="table table-bordered table-striped">
                    <thead>
                      <th>Pagibig No.</th>
                      <th>Employee Id</th>
                      <th>Employee Name</th>
...
<script src = "<?=base_url('assets\js\reports\pagibig_reports.js')?>"></script>
