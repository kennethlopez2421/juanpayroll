                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <select id="employee_id_no" class="form-control">
                                        <option value="<?=$result->employee_id?>"><?=$result->employee_id?></option>
                              ...
                              <!--dates-->
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="date" class = "form-control" id="date_of_file" value = "<?=$result->date_of_file?>">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="date" class = "form-control" id="date_of_effectivity" value = "<?=$result->date_of_effectivity?>">
                                      <span class = "duplicateNameError text-danger d-block"></span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <input type="number" id="amount" class = "form-control" autocomplete="off" value = "<?=$result->amount?>">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Reason<span class = "ml-2 text-danger" >*</span></label>
                                      <input type="text" id="reason" class = "form-control" autocomplete="off" value = "<?=$result->reason?>">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Terms<span class = "ml-2 text-danger" >*</span></label>
                                      <input type="number" id="terms" class = "form-control" autocomplete="off" value = "<?=$result->terms?>">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Rate<span class = "ml-2 text-danger" >*</span></label>
                                      <input type="number" id="rate" class = "form-control" autocomplete="off" value = "<?=$result->rate?>">
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="col-md-12 text-right">
                                    <button id="editCABtn" class="btn btn-primary">Update Cash Advance</button>
                                  </div>
                                </div>
                              </div>
                            </div>
