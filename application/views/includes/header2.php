                ...
                <div class="container-fluid">
                    <div class="navbar-holder d-flex align-items-center justify-content-between w-100">
                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <li class="nav-item"><a href="<?=base_url('admin/Admin/logout');?>" class="nav-link logout"><i class="fa fa-sign-out fa-lg"></i></a></li>
                        </ul>
                    </div>
                </div>
            </nav>
        ...
        <div class="page-content d-flex align-items-stretch">
            ...
            <nav id="sideNav" class="side-navbar sidebar-fixed position-fixed">
                ...
                <div class="side_nav_scroll">
                    <span class="heading">
                      <?=
                        (isset($_SESSION['superuser']) && $_SESSION['superuser'] == true && isset($_SESSION['branch_name']) && $_SESSION['branch_name'] != '')
