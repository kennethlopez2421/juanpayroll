...
<div class="content-inner" id="pageActive" data-num="8" data-namecollapse="" data-labelname="Settings">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Items Category</li>
        </ol>
    </div>
            ...
            <div class="card">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <div id="divName" class = "filter_div single_search active">
                      <label for="Employee Name" class="form-control-label col-form-label-sm">Category Name</label>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-bordered table-striped" id = "item_cat_tbl">
                    <thead>
                      <th width = "100">No.</th>
                      <th>Item Category</th>
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group row">
              <div class="col-md-12">
                <label for="Category Name" class="form-control-label col-form-label-sm">Category Name: <span class="asterisk"></span></label>
                <input type="text" id = "cat_name" name = "cat_name" class="form-control rq">
              </div>
            </div>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group row">
              <div class="col-md-12">
                <label for="Category Name" class="form-control-label col-form-label-sm">Category Name: <span class="asterisk"></span></label>
                <input type="text" id = "edit_cat_name" name = "edit_cat_name" class="form-control rq2">
                <input type="hidden" name = "uid" id = "uid">
              </div>
            </div>
          </div>
          <div class="modal-footer text-right">
            <button type = "submit" id = "btn_submit" class="btn btn-sm btn-primary">Update</button>
            <button type = "button" class="btn blue-grey" data-dismiss = "modal">Close</button>
          </div>
          </form>
        </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="col-lg-12">
                ...
                <input type="hidden" id = "delid" name = "delid" class = "rq3">
            </div>
          </div>
          <div class="modal-footer text-right">
...
<script src = "<?=base_url('assets\js\settings\items_category.js')?>"></script>
