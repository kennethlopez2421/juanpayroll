...
<body data-base_url = "<?=base_url()?>" data-sess_id = "<?=en_dec('en',$this->session->user_id)?>">
  ...
  <input type="hidden" id = "isActivated" value = "<?=(isset($_SESSION['activated']) && $_SESSION['activated'] == true) ? true : false?>">
        ...
        <div  class="img-thumbnail form-control">
          ...
          <?php if(isset($_SESSION['branch_name']) && $_SESSION['branch_name'] != ''):?>
            <div class="col-12 bg-dark text-center text-white p-1 pt-2 mb-2" style = "border-radius:1px;">
              <h5><?=(isset($_SESSION['branch_name']) && $_SESSION['branch_name'] != '') ? $_SESSION['branch_name'].' Facial Recognition' : 'Facial Recognition'?></h5>
        ...
        <div class="card">
          <div class="card-footer text-center" style = "border-top:0;width:">
            <?php if(!$this->session->isLoggedIn):?>
              <button class="btn btn-log" id = "btn_home"><i class="fa fa-home mr-1"></i>Home</button>
            ...
            <?php endif;?>
            <!-- <button class="btn btn-camera" id = "btn_clock_in"><i class="fa fa-clock-o"></i></button> -->
            ...
            <small style = "position:absolute;right:2px;bottom:0;">V.6.5</small>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id = "account_code_modal">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Enter Account Code </h4>
          <!-- <button type="button" class="close" data-dismiss="modal">&times;</button> -->
        </div>
        <form method = "post" id="account_code_form">
          <div class="modal-body">
            <div class="form-group row">
              <div class="col-12">
                <input type="text" id = "bcode" name = "bcode" class="form-control required" required>
