...
<div class="content-inner" id="pageActive" data-num="14" data-namecollapse="" data-labelname="Settings">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Additional Pays</li>
        </ol>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs mt-3">
                            <li class="nav-item">
                                <a class="nav-link active" data-stype = "waiting" data-toggle="tab" id = "waiting_ap" href="#ap_waiting_for_approval" style="color:black;">Waiting for Approval</a>
                            </li>
                            <?php if($this->session->userdata('isLoggedIn')):?>
                              <?php if($this->session->userdata('deptId') == hr_id() || $this->session->userdata('deptId') == 0):?>
                              <li class="nav-item">
                                  <a class="nav-link" data-stype = "approved" data-toggle="tab" id = "approved_ap" href="#ap_approved" style="color:black;" >Approved</a>
                              </li>
                              <li class="nav-item">
                                  <a class="nav-link" data-stype = "certified" data-toggle="tab" id = "certified_ap" href="#ap_certified" style="color:black;" >Certified</a>
                              </li>
                              <?php endif;?>
                            <?php endif;?>
                        </ul>
                        <div class="tab-content">
                          ...
                          <div class="tab-pane fade show active" id = "ap_waiting_for_approval">
                            <div class="card-body">
                          ...
                          <!--additional pay approved -->
                          <div class="tab-pane fade" id = "ap_approved">
                            <div class="card-body">
                              <div class="table-responsive">
                                <table class="table table-bordered text-center" id = "ap_approved_tbl">
                                  <thead>
                                    <tr>
                                      <th width = "50">
                                        <label class="container_label" style = "margin-bottom:0px !important; font-weight:bold !important;top: -10px;">
                          ...
                          <!--additional pay certified -->
                          <div class="tab-pane fade" id = "ap_certified">
                            <div class="card-body">
                              <div class="table-responsive">
                                <table class="table table-bordered text-center" id = "ap_certified_tbl">
                                  <thead>
                                    <tr>
                                      <th>ID</th>
                                      <th>Name</th>
        ...
        <div role="document" class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="exampleModalLabel" class="modal-title">Delete Additional Pays</h4>
                ...
                <form class="form-horizontal personal-info-css" id="deleteCA-form">
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" id="delAPid" class="caid">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <button type="button" id="delAPBtn" style="float:right" class="btn btn-primary delAPBtn">Delete Record</button>
