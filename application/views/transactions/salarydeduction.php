                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                          <div class="form-group row">
                            ...
                            <div class="col-md-3 text-right">
                              ...
                              <a href="<?= base_url('transactions/salarydeduction/add/'.$token) ?>"><button class="btn btn-primary btnClickAddArea">Add</button></a>
                        ...
                        <ul class="nav nav-tabs mt-3">
                            <li class="nav-item">
                                <a class="nav-link active" data-stype = "waiting" data-toggle="tab" id = "sd_waiting_nav" href="#sd_waiting_tab" style="color:black;">Waiting for Approval</a>
                            </li>
                            <?php if($this->session->userdata('isLoggedIn')):?>
                              <?php if($this->session->userdata('deptId') == hr_id() || $this->session->userdata('deptId') == 0):?>
                              <li class="nav-item">
                                  <a class="nav-link" data-stype = "approved" data-toggle="tab" id = "sd_approved_nav" href="#sd_approved_tab" style="color:black;" >Approved</a>
                              </li>
                              <li class="nav-item">
                                  <a class="nav-link" data-stype = "certified" data-toggle="tab" id = "sd_certified_nav" href="#sd_certified_tab" style="color:black;" >Certified</a>
                              </li>
                              <?php endif;?>
                            <?php endif;?>
                        </ul>
                        <div class="tab-content">
                          <div class="tab-pane fade show active" id = "sd_waiting_tab">
                            <div class="card-body">
                          ...
                          <div class="tab-pane fade" id = "sd_approved_tab">
                            <div class="card-body">
                              <div class="table-responsive">
                                <table class="table table-bordered text-center" id="sd_approved_tbl"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
                                  <thead>
                                    <tr>
                                      <th width = "50">
                                        <label class="container_label" style = "margin-bottom:0px !important; font-weight:bold !important;top: -10px;">
                          ...
                          <div class="tab-pane fade" id = "sd_certified_tab">
                            <div class="card-body">
                              <div class="table-responsive">
                                <table class="table table-bordered text-center" id="sd_certified_tbl"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
                                  <thead>
                                    <tr>
                                      <th>ID</th>
                                      <th>Name</th>
        ...
        <div role="document" class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="exampleModalLabel" class="modal-title">Delete Salary Deduction</h4>
                ...
                <form class="form-horizontal personal-info-css" id="deleteCA-form">
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" id="delSalDecid" class="delSalDecid">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <button type="button" id="delSalDecBtn" style="float:right" class="btn btn-primary delSalDecBtn">Delete Record</button>
