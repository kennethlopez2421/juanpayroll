...
<div class="content-inner" id="pageActive" data-num="14" data-namecollapse="" data-labelname="Settings">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Overtime Pays History</li>
        </ol>
    </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped table-bordered table-hover" id = "otpays_history_tbl">
                    <thead>
                      <th>History Logs</th>
                      <th>Date</th>
                    </thead>
...
<script src="<?=base_url('assets/js/transactions/overtimepays_history.js');?>"></script>
