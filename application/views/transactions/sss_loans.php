...
<div class="content-inner" id="pageActive" data-num="14" data-namecollapse="" data-labelname="Transactions">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">SSS Loans</li>
        </ol>
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id = "sss_loan_tbl" class="table table-striped table-bordered">
                    <thead>
                      <th width = "80">SSS Voucher</th>
                      <th>Employee</th>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">SSS Loans</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <form id="sss_loan_form">
            <div class="modal-body">
              <div class="form-group row">
                ...
                <div class="col-12 mb-3">
                  <label for="SSS Voucher" class="form-control-label col-form-label-sm">Upload SSS Voucher <span class="asterisk"></span></label>
                  <input type="file" id = "sss_voucher" name = "sss_voucher" class = "form-control" placeholder=".jpg, jpeg, png">
    ...
    <div class="modal fade" id = "view_modal">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">SSS Loan</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <div class="modal-body">
            <div class="form-group row">
            ...
            <div class="form-group">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id = "view_sss_loan_tbl" style = "border: 1px solid gainsboro;">
                  <thead>
                    <th>Month</th>
...
<script src = "<?=base_url('assets\js\transactions\sss_loans.js')?>"></script>
