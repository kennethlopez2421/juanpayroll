...
<div class="content-inner" id="pageActive" data-num="14" data-namecollapse="" data-labelname="Settings">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Overtime Pays</li>
        </ol>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                          ...
                          <div class="form-group row">
                            <div class="col-md-3">
                              ...
                              <select name="" id="filter_by" class="form-control">
                                ...
                                <option value="by_minutes">Minutes</option>
                              </select>
                            </div>
                            ...
                            <div class="col-md-6">
                              ...
                              <div id="divMin" class = "filter_div" style = "display:none;">
                                <label for="Amount" class="form-control-label col-form-label-sm">Minutes</label>
                                <div class="row">
                                  <div class="col-md-6">
                                    <input type="number" id = "min_from" class="form-control">
                                    <small class="form-text">From</small>
                                  </div>

                                  <div class="col-md-6">
                                    <input type="text" id = "min_to" class="form-control">
                                    <small class="form-text">To</small>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="col-md-3 text-right">
                              ...
                              <a href="<?= base_url('transactions/Overtimepays/add/'.$token) ?>"><button class="btn btn-primary btnClickAddArea">Add</button></a>
                        ...
                        <ul class="nav nav-tabs mt-3">
                            <li class="nav-item">
                                <a class="nav-link active" data-stype = "waiting" data-toggle="tab" id = "waiting_ot_tab" href="#ot_waiting" style="color:black;">Waiting for Approval</a>
                            </li>
                            <?php if((approve_access($access_ids) && $this->session->login_type == 'admin') || $this->session->login_type != 'admin'):?>
                              <li class="nav-item">
                                  <a class="nav-link" data-stype = "approved" data-toggle="tab" id = "approved_ot_tab" href="#ot_approved" style="color:black;" >Approved</a>
                              </li>
                            <?php endif;?>
                            <?php if((certify_access($access_ids) && $this->session->login_type == 'admin') || $this->session->login_type != 'admin'):?>
                              <li class="nav-item">
                                  <a class="nav-link" data-stype = "certified" data-toggle="tab" id = "certified_ot_tab" href="#ot_certified" style="color:black;" >Certified</a>
                              </li>
                            <?php endif;?>

                        </ul>
                        <div class="tab-content">
                          <div class="tab-pane fade show active" id = "ot_waiting">
                            <div class="card-body">
                          ...
                          <div class="tab-pane fade" id = "ot_approved">
                            <div class="card-body">
                              <div class="table-responsive">
                                <table class="table table-bordered text-center" id="approved_ot_tbl"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
                                  <thead>
                                    <tr>
                                      <th width = "50">
                                        <label class="container_label" style = "margin-bottom:0px !important; font-weight:bold !important;top: -10px;">
                          ...
                          <div class="tab-pane fade" id = "ot_certified">
                            <div class="card-body">
                              <div class="table-responsive">
                                <table class="table table-bordered text-center" id="certified_ot_tbl"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
                                  <thead>
                                    <tr>
                                      <th>ID</th>
                                      <th>Name</th>
        ...
        <div role="document" class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="exampleModalLabel" class="modal-title">Delete Overtime Pay</h4>
                ...
                <form class="form-horizontal personal-info-css" id="deleteCA-form">
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" id="delOPid" class="caid">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <button type="button" id="delOPBtn" style="float:right" class="btn btn-primary delCABtn">Delete Record</button>
