                ...
                <div class="col-lg-12">
                    <div class="card">
                          ...
                          <div class="form-group row">
                            <div class="col-md-3">
                              ...
                              <select name="" id="filter_by" class="form-control">
                                ...
                                <option value="by_date">Date File</option>
                                <option value="by_date">Date of Effectivity</option>
                                <option value="by_amount">Amount</option>
                                <!-- <option value="by_fee">Processing Fee</option> -->
                                <!-- <option value="by_term">Term</option> -->
                              </select>
                            </div>
                            ...
                            <div class="col-md-6">
                              ...
                              <div id="divDate" class = "filter_div" style = "display:none;">
                                <label for="Date" class="form-control-label col-form-label-sm">Date File</label>
                                <div class="row">
                                  <div class="col-md-6">
                                    <input type="text" id = "dof_from" class="form-control date_input" placeholder="Ex. yyyy-mm-dd">
                                    <small class="form-text">From</small>
                                  </div>
                                  <div class="col-md-6">
                                    <input type="text" id = "dof_to" class="form-control date_input" placeholder="Ex. yyyy-mm-dd">
                                    <small class="form-text">To</small>
                                  </div>
                                </div>
                              </div>

                              <div id="divDate2" class = "filter_div" style = "display:none;">
                                <label for="Date" class="form-control-label col-form-label-sm">Date of Effectivity</label>
                                <div class="row">
                                  <div class="col-md-6">
                                    <input type="text" id = "doe_from" class="form-control date_input" placeholder="Ex. yyyy-mm-dd">
                                    <small class="form-text">From</small>
                                  </div>
                                  <div class="col-md-6">
                                    <input type="text" id = "doe_to" class="form-control date_input" placeholder="Ex. yyyy-mm-dd">
                                    <small class="form-text">To</small>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div id="divFee" class = "filter_div" style = "display:none;">
                                <label for="Amount" class="form-control-label col-form-label-sm">Processing Fee</label>
                                <div class="row">
                                  <div class="col-md-6">
                                    <input type="number" id = "fee_from" class="form-control">
                                    <small class="form-text">From</small>
                                  </div>

                                  <div class="col-md-6">
                                    <input type="text" id = "fee_to" class="form-control">
                                    <small class="form-text">To</small>
                                  </div>
                                </div>
                              </div>

                              <div id="divTerm" class = "filter_div" style = "display:none;">
                                <label for="Amount" class="form-control-label col-form-label-sm">Term(Number of Months)</label>
                                <div class="row">
                                  <div class="col-md-6">
                                    <input type="number" id = "term_from" class="form-control">
                                    <small class="form-text">From</small>
                                  </div>

                                  <div class="col-md-6">
                                    <input type="text" id = "term_to" class="form-control">
                                    <small class="form-text">To</small>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="col-md-3 text-right">
                              ...
                              <a href="<?= base_url('transactions/Cashadvance/add/'.$token) ?>"><button class="btn btn-primary btnClickAddArea">Add</button></a>
                        ...
                        <ul class="nav nav-tabs mt-3">
                            <li class="nav-item">
                                <a class="nav-link active" data-stype = "waiting" data-toggle="tab" id = "ca_waiting_nav" href="#ca_waiting_tab" style="color:black;">Waiting for Approval</a>
                            </li>
                            <?php if($this->session->userdata('isLoggedIn')):?>
                              <?php if($this->session->userdata('deptId') == hr_id() || $this->session->userdata('deptId') == 0):?>
                                <li class="nav-item">
                                    <a class="nav-link" data-stype = "approved" data-toggle="tab" id = "ca_approved_nav" href="#ca_approved_tab" style="color:black;" >Approved</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-stype = "certified" data-toggle="tab" id = "ca_certified_nav" href="#ca_certified_tab" style="color:black;" >Certified</a>
                                </li>
                              <?php endif;?>
                            <?php endif;?>
                        </ul>
                        <div class="tab-content">
                          <div class="tab-pane fade show active" id = "ca_waiting_tab">
                            <div class="card-body">
                                ...
                                <table class="table table-bordered text-center" id="caTable"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
                                  <thead>
                                    <tr>
                                      ...
                                      <th>ID</th>
                                      <th>Name</th>
                                      <th width = "70">Date of file</th>
                                      <th width = "70">Date of Effectivity</th>
                                      <th>Amount</th>
                          ...
                          <div class="tab-pane fade" id = "ca_approved_tab">
                            <div class="card-body">
                              <div class="table-responsive">
                                <table class="table table-bordered text-center" id="ca_approve_tbl"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
                                  <thead>
                                    <tr>
                                      <th width = "50">
                                        <label class="container_label" style = "margin-bottom:0px !important; font-weight:bold !important;top: -10px;">
                          ...
                          <div class="tab-pane fade" id = "ca_certified_tab">
                            <div class="card-body">
                              <div class="table-responsive">
                                <table class="table table-bordered text-center" id="ca_certified_tbl"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
                                  <thead>
                                    <tr>
                                      <th>ID</th>
                                      <th>Name</th>
